package com.example.LeetCode.L92_reversedLinkedList;

import static org.junit.Assert.assertTrue;

import org.junit.Test;

import com.example.LeetCode.L92_reversedLinkedListII.ReversedLinkedListII;
    ...
    public void testReverseBetween() {
        ...
        for (int i = 0; i < cases.length; i++) {
            assertTrue(Utils.IsSameListNode(
                    ReversedLinkedListII.reverseBetween(cases[i].head, cases[i].left, cases[i].right), ans.next));
        }
    }
}
